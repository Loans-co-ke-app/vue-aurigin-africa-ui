class AuriginAfricaValidator {
  ...
  static validPhone(phone: string): boolean {
    return AuriginAfricaValidator.phoneRegex.test(phone);
  }
  /**
   *
  ...
  static passwordSpecialCharacters(password: string): boolean {
    ...
    return AuriginAfricaValidator.specialCharacters.test(password);
  }
  /**
   * @param password string
   * @returns
...
export default AuriginAfricaValidator;
export { AuriginAfricaValidator };
